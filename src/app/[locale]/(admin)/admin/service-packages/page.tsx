...
import ServicePackageEditor from "@/components/admin/service-packages/ServicePackageEditor";
...
export default function AdminServicePackagesPage() {
  ...
  const [pendingDelete, setPendingDelete] = useState<ServicePackage | null>(
    null
  );
      ...
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Manage package pricing and deliverables.
          </p>
        </div>
        <Button onClick={() => setIsCreateOpen(true)}>Create package</Button>
      </div>
            ...
            <div className="mt-5 flex items-center justify-end gap-2">
              ...
              <Button
                ...
                onClick={async () => {
                  ...
                  try {
                    await deleteAdminServicePackage(pendingDelete._id);
          ...
          >
            <div className="flex items-center justify-between border-b border-slate-200 bg-white px-6 py-4">
              <div>
                ...
                <Dialog.Description className="text-xs text-muted-foreground">
                  Update pricing and deliverables.
                </Dialog.Description>
              </div>
              <Dialog.Close asChild>
                <Button variant="outline" className="rounded-full">
