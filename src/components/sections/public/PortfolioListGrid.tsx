...
export default function PortfolioListGrid({
  ...
  const tagLabel = locale === "en" ? "Tags" : "Chu de";
          ...
          visibleItems.map((item) => {
            ...
            return (
              <Link
                ...
                href={href}
                className={cn(
                  "group overflow-hidden rounded-3xl border border-white/70 bg-white shadow-[0_25px_70px_-55px_rgba(15,23,42,0.6)] transition",
                  "hover:-translate-y-1 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-white"
                )}
              >
                <div className="relative aspect-[4/3] w-full overflow-hidden">
                  <img
                    ...
                    decoding="async"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-neutral-950/70 via-neutral-950/20 to-transparent opacity-0 transition duration-300 group-hover:opacity-100" />
